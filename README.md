...
### Preprocess data and generate input for the model
...
We provide parameters of model pretrained using PXD002892 SEC2-heavy data. <br />
...
```
python -W ignore ./Code/run_FREEPII.py -out_path 'test_output' -pretrain_w 'pretrained_model/SEC2-heavy_best_stat_dict'
```
