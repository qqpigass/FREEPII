...
nrow(Uname_subloc_df) # 44824
colnames(Uname_subloc_df)
c(length(unique(Uname_subloc_df$UniProt_entry)), length(unique(Uname_subloc_df$Location))) # 16978   257
...
nrow(co_subloc_df) # 1012
colnames(co_subloc_df)
length(unique(c(co_subloc_df$Term, co_subloc_df$CoocTerm))) # 150
...
c( nrow(Gname_subloc_df), sum(complete.cases(Gname_subloc_df)) ) # 104495 104495
